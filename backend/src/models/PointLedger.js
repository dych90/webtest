...
pointLedgerSchema.index({ studentId: 1, teacherId: 1, occurredAt: -1 })
pointLedgerSchema.index({ settlementId: 1, occurredAt: -1 })
pointLedgerSchema.index({ businessType: 1, businessId: 1 })
attachUpdatedAtHooks(pointLedgerSchema)
